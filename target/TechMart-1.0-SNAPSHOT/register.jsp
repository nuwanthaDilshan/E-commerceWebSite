<%-- 
    Document   : register
    Created on : Feb 20, 2022, 9:08:28 AM
    Author     : nuwan
--%>
...
<html>
    <head>
        ...
        <title>TechMart-Registration</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body px-5">
                            ...
                            <div class="container text-center">
                                <img src="images/registration icon.png" style="max-width: 100px;" class="img-fluid" alt="alt"/>
                            </div>
                            ...
                            <form action="RegisterServlet" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="user_address" style="height:200px;" class="form-control" placeholder="Enter here" required=""></textarea>
                                </div>
