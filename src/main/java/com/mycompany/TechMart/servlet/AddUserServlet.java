...
import com.mycompany.TechMart.dao.crudUserDao;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           if (add.trim().equals("adduser")) {
                ...
                crudUserDao crudUserDao = new crudUserDao (FactoryProvider.getFactory());
                boolean userId = crudUserDao.addUser(user);
